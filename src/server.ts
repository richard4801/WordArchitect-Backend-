...
import { manuscriptChaptersRouter } from "./routes/manuscriptChapters.js";
import { worldCategoriesRouter } from "./routes/worldCategories.js";
...
app.use("/api/v1", manuscriptChaptersRouter);
app.use("/api/v1", worldCategoriesRouter);
